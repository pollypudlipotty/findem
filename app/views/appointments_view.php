        ...
        <div class="row justify-content-around">
            <?php foreach ($services as $service): ?>
                <button class="btn btn-primary position-relative col m-2 serviceCategories"
                        onclick="sortCategories(<?php echo $service['category_id'] . ',' . $_SESSION['user']; ?>);"><?php echo htmlentities($service['category_name']); ?></button>
            <?php endforeach; ?>
        </div>
    </div>
                    ...
                    <div class="card m-5">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle mb-2 text-body-secondary">
                                <span>szolgáltató: </span><?php echo htmlentities($appointment['service_name']); ?></h6>
                            <h6 class="card-subtitle mb-2 text-body-secondary">
                            ...
                            <?php if ($appointment['service_provider_id'] !== $_SESSION['user']): ?>
