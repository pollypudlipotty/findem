...
<div class="d-flex justify-content-center joinUSBox">
    <div>
        ...
        <div>
            <h3><a id="joinUsText" class="link-underline link-underline-opacity-0" href="/registration" onclick="redirectToPage('/registration')">Csatlakozz
                    hozzánk és regisztálj!</a></h3>
        </div>
    </div>
